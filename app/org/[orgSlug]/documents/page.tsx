  ...
  return (
    <div className="option-surface space-y-4 p-6 md:p-8">
      <div className="option-panel rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-wider text-slate-500">Documents</p>
        <p className="mt-1 text-sm text-slate-600">Upload and manage your documents, salary view, and responsibilities.</p>
      </div>
      <DocumentsTab user={user} isResigned={Boolean(user?.is_resigned)} />
    </div>
  );
}
